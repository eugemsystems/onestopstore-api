    ...
    public function run()
    {
        ...
        if (isset($request['admin']) && Request::route()?->getName() == 'install.database.config') {
            $admin = User::factory()->create([
                ...
                'email' => $request['admin']['email'] ?? 'admin@'.config('app.app_emails_domain'),
        ...
        $consumer = User::factory()->create([
            ...
            'email' => 'consumer@'.config('app.app_emails_domain'),
            'password' => Hash::make('123456789'),
            'country_code' => (string) '1',
            'phone' => '78945622',
        ...
        $vendor = User::factory()->create([
            'name' => 'Vendor System',
            'email' => 'vendor@'.config('app.app_emails_domain'),
            'password' => Hash::make('123456789'),
            'country_code' => (string) '1',
            'phone' => '764236512',
            'system_reserve' => false,
        ...
        $store = Store::create([
            ...
            'description' => 'Welcome to '.config('app.name').', your premier destination for high-quality goods at affordable rates in South Africa, Zimbabwe, and Zambia.',
            'country_id' => 356,
            'state_id' => 1,
            'city' => 'Harare',
