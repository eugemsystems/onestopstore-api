...
/**
 * @OA\Tag(name="Vendor Wallet", description="Vendor wallet transactions")
 */
class VendorWalletController extends Controller
{
     ...
     *
     * @OA\Post(
     *   path="/api/credit/vendorWallet",
     *   tags={"Vendor Wallet"},
     *   summary="Credit vendor wallet",
     *   security={{"bearerAuth":{}}},
     *   @OA\Response(response=200, description="OK")
     * )
     */
     ...
     *
     * @OA\Post(
     *   path="/api/debit/vendorWallet",
     *   tags={"Vendor Wallet"},
     *   summary="Debit vendor wallet",
     *   security={{"bearerAuth":{}}},
     *   @OA\Response(response=200, description="OK")
     * )
     */
