...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1"><i class="bi bi-pencil-square"></i> Edit Role</h2>
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info mb-0">
                            <small>
                                ...
                                <strong>Users:</strong> {{ $role->users->count() }}<br>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-3">Select which permissions this role should have. Users with this role will inherit these permissions.</p>
