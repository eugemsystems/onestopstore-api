...
@section('title', 'Import History - Fast Import Update')
...
<div class="container-fluid">
    ...
    <div class="history-card">
        <div class="d-flex justify-content-between align-items-start">
            <div>
                <h3><i class="bi bi-clock-history me-2"></i>Import History - Fast Import Update</h3>
                <p>View all import jobs, track progress, and manage failed imports</p>
            </div>
            <a href="{{ route('admin.import-fast-update.index') }}" class="btn btn-light btn-sm">
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="historyTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a href="{{ route('admin.import-fast-update.batch-details', $job->batch_id) }}" class="batch-link">
                                    {{ $job->batch_id }}
                                </a>
                            </td>
                            <td>{{ $job->filename }}</td>
...
async function retryJob(batchId) {
    ...
    fetch('{{ route("admin.import-fast-update.resume-failed") }}', {
        method: 'POST',
        headers: {
