...
<body>
    <div class="container">
        ...
        <!-- Footer with Currency-based Company Address -->
        <div class="footer">
            ...
            <p style="margin-top: 10px; font-size: 9px;">This is a computer-generated document and does not require a physical signature.</p>
        </div>
    </div>
</body>
</html>
