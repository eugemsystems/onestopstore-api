{{-- PayFast filter form + lazy-load container --}}
<div class="filters-card">
    <form id="filter-form-payfast" onsubmit="applyFilter('payfast');return false;">
        <div class="filters-grid">
            <div class="filter-group">
                <label>Search</label>
                <input type="text" name="search" placeholder="PF ID, item name, email…">
            </div>
            <div class="filter-group">
                <label>Status</label>
                <select name="status">
            ...
            <div class="filter-group" style="display:flex;flex-direction:row;align-items:flex-end;gap:6px">
                ...
                <button type="button" class="btn-filter clear" onclick="clearFilter('payfast')"><i class="bi bi-x-circle"></i> Clear</button>
            </div>
        </div>
    </form>
</div>
