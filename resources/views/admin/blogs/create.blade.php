...
@section('title', 'Create Blog - Admin Panel')
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="bi bi-plus-circle me-2"></i>Create Blog</h2>
        <div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="form-section">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" required placeholder="Enter blog title">
                        @error('title')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="Short excerpt or summary">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="upload-area" onclick="document.getElementById('blog_thumbnail').click()">
                            ...
                            <p class="mb-0 mt-1 text-muted small">Click to upload thumbnail image</p>
                        ...
                        <div class="image-preview-container">
                            <div class="image-preview-box" id="thumbnail-preview">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="upload-area" onclick="document.getElementById('blog_meta_image').click()">
                            <i class="bi bi-cloud-arrow-up" style="font-size: 1.5rem; color: #667eea;"></i>
                            <p class="mb-0 mt-1 text-muted small">Click to upload meta image for SEO</p>
                            <p class="mb-0 text-muted" style="font-size: 0.75rem;">JPEG, PNG, JPG, WEBP (max 5MB)</p>
                        </div>
                        ...
                        @enderror
                        <div class="image-preview-container">
                            <div class="image-preview-box" id="meta-image-preview">
                ...
                <div class="form-section">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="meta_title" id="meta_title" class="form-control" value="{{ old('meta_title') }}" placeholder="SEO title (defaults to blog title if empty)">
                    </div>

                    <div class="mb-3">
                        <label for="meta_description" class="form-label fw-semibold">Meta Description</label>
                        <textarea name="meta_description" id="meta_description" class="form-control" rows="3" placeholder="SEO description for search engines">{{ old('meta_description') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="form-section">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_sticky" id="is_sticky" value="1" {{ old('is_sticky') ? 'checked' : '' }}>
...
<script>
    ...
    // Track whether user has pasted raw HTML (to avoid Quill mangling it)
    var rawHtmlContent = '';
    ...
    async function switchToVisual() {
        // If coming from source with raw HTML, warn that Quill will strip some tags
        if (editorMode === 'source' && rawHtmlContent) {
            // Don't push raw HTML into Quill — it strips tables/styles
            // Only switch if rawHtmlContent is empty (user hasn't typed in source)
            ...
            if (source.value.trim() && source.value !== quill.root.innerHTML) {
                ...
                rawHtmlContent = ''; // User chose to convert
            }
        }
        hideAll();
    ...
    function switchToSource() {
        hideAll();
        var source = document.getElementById('html-source');
        // If we have raw HTML content, use that; otherwise dump from Quill
    ...
    function switchToPreview() {
        ...
        // Get content from whatever is current
        var html = '';
        if (rawHtmlContent) {
            html = rawHtmlContent;
    ...
    // Track changes in source textarea to preserve raw HTML
    ...
    document.getElementById('blogForm').addEventListener('submit', function() {
        if (rawHtmlContent) {
            // Raw HTML was pasted in source mode — use it directly (preserves tables, styles, etc.)
            document.getElementById('content-input').value = rawHtmlContent;
        } else {
            // Visual mode content from Quill
    ...
    var allFlatCategories = [];
    var oldSelectedCategories = @json(old('categories', []));
    ...
    async function loadBlogCategories() {
        ...
        try {
            ...
            // No flattening needed — render directly
    ...
    var allTags = [];
    var oldSelectedTags = @json(old('tags', []));
